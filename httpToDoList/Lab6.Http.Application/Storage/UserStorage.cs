...
class TaskStorage : StorageBase<TaskItem>, ITaskApi
{
    private static readonly Dictionary<int, TaskItem> defaultData
        ...
        {
            [1] = new TaskItem(1, "Бегущий по лезвию", "Там есть райан гослинг значит фильм топ"),
            [2] = new TaskItem(2, "Драйв", "Там очень крутые тачки"),
            [3] = new TaskItem(3, "Веном", "Том харди - ван лав"),
        };
